...
@section('content')
				...
				<div class="modal-dialog" role="document">
			    	<div class="modal-content">
				    	...
				    	<div class="modal-body">
							<form class="dropzone" method="POST" action="/clerks/{{$clerk->id}}/photos">
								{{ csrf_field() }}
								{{ method_field('PUT') }}
							</form>
						</div>
	...
	@include('merchants.outlets.table', [
		'merchant' => $clerk->merchant,
	...
	@include('dashboard._delete', [
		'route'	=> route('clerk.clerks.destroy', [$clerk->id])
	])
@endsection
